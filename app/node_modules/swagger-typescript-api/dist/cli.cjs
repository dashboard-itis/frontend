#!/usr/bin/env node
const require_src = require("./src-DNKGwk6n.cjs");
...
const generateCommand = (0, citty.defineCommand)({
	meta: {
		name: "generate",
		description: require_src.description
	},
	args: {
		"add-readonly": {
			type: "boolean",
	...
	run: async ({ args }) => {
		const customConfig = await (0, c12.loadConfig)({
...
(0, citty.runMain)((0, citty.defineCommand)({
	meta: {
		name: require_src.name,
		description: require_src.description,
		version: require_src.version
	},
	subCommands: {
