...
import * as yummies_types0 from "yummies/types";
...
declare class SchemaUtils {
  ...
  isBinaryLikeMimeType: (contentMediaType: unknown) => boolean;
...
declare class ResolvedSwaggerSchema {
  ...
  private originalProducesByRoute;
  private constructor();
  ...
  static create(config: CodeGenConfig, usageSchema: OpenAPI.Document, originalSchema: OpenAPI.Document, originalProducesByRoute?: Record<string, Record<string, string[]>>): Promise<ResolvedSwaggerSchema>;
}
//#endregion
...
declare class SchemaRoutes {
  ...
  isBinaryOnlyContentTypes: (contentTypes: string[]) => boolean;
  ...
  getResponseBodyInfo: (routeInfo: any, parsedSchemas: any, resolvedSwaggerSchema: any, pathName?: string, method?: string) => {
    contentTypes: any[];
    responses: any[];
    links: any[];
    typesToCheck: any;
...
declare class SwaggerSchemaResolver {
  ...
  processSwaggerSchemaFile(file: string): yummies_types0.AnyObject;
