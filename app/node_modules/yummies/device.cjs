...
const getUserAgent = () => (navigator.userAgent || navigator.vendor || // @ts-expect-error skip opera
globalThis.opera || "").toLowerCase();
...
const checkIsTouchDevice = () => checkIsMobileDevice() || checkIsTabletDevice();
const isMobileDevice = checkIsMobileDevice();
const isTabletDevice = checkIsTabletDevice();
const isTouchDevice = isMobileDevice || isTabletDevice;
